  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-3xl mx-auto">
        <div className="bg-white border border-gray-200 border-l-4 border-l-green-600 rounded-2xl p-5 text-center no-break">
          ...
          <p className="text-sm text-gray-400 font-normal mt-1">
            {Math.round(report.carbon.annual_co2_offset_tons * 3.28) >= 12 ? 'Equivalent to eliminating 1 full year of fossil fuel heating emissions' : 'of home heating demand offset annually'}
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 border-l-4 border-l-green-600 rounded-2xl p-5 text-center no-break">
          ...
          <p className="text-sm text-gray-400 font-normal mt-1">
            worth of lifetime carbon absorption
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 border-l-4 border-l-green-600 rounded-2xl p-5 text-center no-break">
          ...
          <p className="text-sm text-gray-400 font-normal mt-1">
            NYC to Miami avoided over 25 years
          </p>
        </div>
      </div>
